...
class Employee(Base):
    ...
    fixed_start_time: Mapped[Optional[str]] = mapped_column(String(5), nullable=True)
...
class TimeEvent(Base):
    ...
    effective_ts_utc: Mapped[Optional[datetime]] = mapped_column(DateTime, index=True, nullable=True)
